...
console.log("(@colyseus/state) INITIAL STATE SIZE:", state.encode().length);
...
const subsequent = state.encode();
console.log(subsequent);

console.log("(@colyseus/state) SUBSEQUENT PATCH:", subsequent.length);
